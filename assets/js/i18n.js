...
const I18N = {
  ko: {
    ...
    "pro.ads": "광고 제거",
    "pro.liveActivities": "지원되는 Apple 기기에서 실시간 현황 사용",
    "pro.credits": "매주 무료 크레딧 제공",
    "pro.trips": "최대 여행 수 증가",
    "pro.friends": "친구 초대 수 증가",
    "pro.savedItems": "임시보관함 장소 저장 개수 증가",
    "pro.expenseImages": "지출 내역과 공동경비에 사진 추가",
  ...
  en: {
    ...
    "pro.ads": "Remove ads",
    "pro.liveActivities": "Live Activities on supported Apple devices",
    "pro.credits": "Free credits provided weekly",
    "pro.trips": "Increased maximum trips",
    "pro.friends": "Increased friend invite limit",
    "pro.savedItems": "Increased saved items limit",
    "pro.expenseImages":
      "Add photos to expenses and shared fund contributions",
  ...
  ja: {
    ...
    "pro.title": "Somewhere Pro",
    "pro.ads": "広告を削除",
    "pro.liveActivities": "対応するApple端末でリアルタイム情報を利用",
    "pro.credits": "毎週無料クレジットを提供",
    "pro.trips": "作成できる旅行数を拡大",
    "pro.friends": "友だち招待数を拡大",
    "pro.savedItems": "保存済みスポットの保存数を拡大",
    "pro.expenseImages": "支出記録と共同経費に写真を追加",
  ...
  "zh-CN": {
    ...
    "pro.title": "Somewhere Pro",
    "pro.ads": "移除广告",
    "pro.liveActivities": "在受支持的 Apple 设备上使用实时状态",
    "pro.credits": "每周提供免费积分",
    "pro.trips": "增加可创建的旅行数量",
    "pro.friends": "增加好友邀请数量",
    "pro.savedItems": "增加暂存地点的保存数量",
    "pro.expenseImages": "可在支出和共同基金中添加照片",
  ...
  "zh-TW": {
    ...
    "pro.title": "Somewhere Pro",
    "pro.ads": "移除廣告",
    "pro.liveActivities": "在受支援的 Apple 裝置上使用即時狀態",
    "pro.credits": "每週提供免費點數",
    "pro.trips": "增加可建立的旅程數量",
    "pro.friends": "增加好友邀請數量",
    "pro.savedItems": "增加暫存地點的儲存數量",
    "pro.expenseImages": "可在支出和共同基金中新增相片",
  ...
  fr: {
    ...
    "pro.liveActivities":
      "Activités en direct sur les appareils Apple compatibles",
    "pro.credits": "Crédits gratuits offerts chaque semaine",
    "pro.trips": "Nombre maximal de voyages augmenté",
    "pro.friends": "Limite d’invitations d’amis augmentée",
    "pro.savedItems": "Limite de lieux temporaires augmentée",
    "pro.expenseImages":
      "Ajoutez des photos aux dépenses et à la cagnotte",
  ...
  de: {
    ...
    "pro.liveActivities": "Live-Aktivitäten auf unterstützten Apple-Geräten",
    "pro.credits": "Kostenlose Credits pro Woche",
    "pro.trips": "Höhere maximale Anzahl an Reisen",
    "pro.friends": "Höhere Grenze für Freundeseinladungen",
    "pro.savedItems": "Höhere Grenze für gespeicherte Orte",
    "pro.expenseImages":
      "Fotos zu Ausgaben und Gemeinschaftskassen hinzufügen",
  ...
  es: {
    ...
    "pro.liveActivities":
      "Actividades en directo en dispositivos Apple compatibles",
    "pro.credits": "Créditos gratis cada semana",
    "pro.trips": "Más viajes como máximo",
    "pro.friends": "Más invitaciones de amigos",
    "pro.savedItems": "Más lugares guardados",
    "pro.expenseImages": "Añade fotos a gastos y fondos comunes",
